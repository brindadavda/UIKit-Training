...
//        cropview != nil ? self.cropview.sendSubviewToBack(self.photoView) : self.view.sendSubviewToBack(self.photoView)
...
//        IGRPhotoContentView.appearance().backgroundColor = UIColor.clear
        ...
        IGRCropCornerView.appearance().backgroundColor = UIColor.black
//        IGRCropCornerView.appearance().backgroundColor = UIColor.yellow
